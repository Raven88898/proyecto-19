...
function draw() {
 ...
 text("instrucciones",20,35);
  textSize(15);
  text("flecha hacia arriba = a cepillarse",20,55);
  text("flecha hacia abajo = a ejercitarse",20,70);
  text("flecha hacia la izquierda = a comer",20,85);
  text("flecha hacia la derecha = a bañarse",20,100);
  text("tecla m = a moverse",20,115);
